                        ...
                        <div class="appointment-form p-5" class="center">
                            ...
                            <form method="post" action="">
                                <div class="row gy-3 gx-4"> 
                                    <div class="col-lg-12">
                                    <input type="text" class="form-control py-3 border-white bg-transparent text-white" value="<?php echo $row['NIS']; ?>" name="NIS" >
                                    </div>
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control py-3 border-white bg-transparent text-white" value="<?php echo $row['nama']; ?>" name="nama">
                                    </div>
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control py-3 border-white bg-transparent text-white" name="id_kelas" value="<?php echo $row['id_kelas']; ?>">
                                    </div>
                                    <div class="col-lg-12">
