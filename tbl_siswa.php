                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light navbar-expand-xl">
                        ...
                        <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="tbl_siswa.php" class="nav-item nav-link active">Siswa</a>
...
<div class="col-9">
<a href='inputsiswa.php'><button type='button' class='btn btn-primary my-3'>TAMBAH DATA</button></a>
...
$opsi=$_POST["pilih"];
$nama=$_POST["textcari"];
$input=mysqli_query($koneksi, "SELECT * from siswa WHERE $opsi like '%$nama%'");
}else{
...
<td>" . $row['id_kelas'] . "</td>
<td>
<a href='updatesiswa.php?NIS=$row[NIS]'><button type='button' class='btn btn-primary my-3'>Update</button></a>
<a href='hapussiswa.php?NIS=$row[NIS]'><button type='button' class='btn btn-danger my-3'>Hapus</button></a>
</td>
</tr>";
}
?>
